						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li><a href="<?php echo e(route('Left-sidebar')); ?> ">hola</a></li>
									<li class="break"><a href="<?php echo e(route('right-sidebar')); ?>">inicio</a></li>
									<li><a href="<?php echo e(route('No-sidebar')); ?>">No Sidebar</a></li>
								</ul>
							</nav>
...
</html><?php /**PATH C:\Users\Toshiba\Desktop\Nueva carpeta\blog\resources\views/template/index.blade.php ENDPATH**/ ?>