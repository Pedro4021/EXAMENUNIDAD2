...
<html>
	<head>
		<title>SISTEMAS DE CONEXION ATRAVES DE RED</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1>SISTEMAS DE CONEXION ATRAVES DE RED</h1>
					...
					<div id="main">
						...
						<!-- Content -->
							<section id="content" class="main">
								...
								<h2>¿Qué son los sistemas de conexion atravez de red?</h2>
				...
				<!-- Footer -->
					<footer id="footer">
						<section>
							<h2>inicio</h2>
							<ul class="actions">
								<li><a href="redes.html" class="button">Volver</a></li>
							</ul>
						</section>
						<section>
							<h2>CONTACTO</h2>
...
</html><?php /**PATH C:\Users\Toshiba\Desktop\ur\Nueva carpeta\blog\resources\views/blog/red.blade.php ENDPATH**/ ?>